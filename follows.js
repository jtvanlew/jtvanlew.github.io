(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'Jvpv9pxWgJskXohL9gewXpvSWBaRLU6rWFv4BhApS4v8uofi', // Unique master Xively API key to be used as a default
		defaultFeeds	= [26976849], // Comma separated array of Xively Feed ID numbers
							...
							xively.datastream.history(feedId, datastream.id, {duration: duration, interval: interval, limit: 1000}, function(datastreamData) {
								...
								if(datastreamData.datapoints) {
									...
									var graph = new Rickshaw.Graph( {
										...
										min: 55,//parseFloat(datastream.min_value) - .25*(parseFloat(datastream.max_value) - parseFloat(datastream.min_value)),
										max: 85,
